...
object Function {
  ...
  def invert2[T1, T2, R](f: T1 => T2 => R): T2 => T1 => R = a => b => f(b)(a) // TO BE IMPLEMENTED
  ...
  def invert3[T1, T2, T3, R](f: T1 => T2 => T3 => R): T3 => T2 => T1 => R = a => b => c => f(c)(b)(a) // TO BE IMPLEMENTED
  ...
  def invert4[T1, T2, T3, T4, R](f: T1 => T2 => T3 => T4 => R): T4 => T3 => T2 => T1 => R = a => b => c => d => f(d)(c)(b)(a) // TO BE IMPLEMENTED
